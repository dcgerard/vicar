...
#'     \item{ctl}{A logical vector where a \code{TRUE} at location \eqn{i} indicates the presence of a control gene at location \eqn{i} in \code{Y} and a \code{FALSE} at location \eqn{i} indicates the absence of a control gene at location \eqn{i} of \code{Y}.}
